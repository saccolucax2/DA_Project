...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{images/Matrix} % ad esempio 60% della larghezza della pagina
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{images/k-distance-DBSCAN}
