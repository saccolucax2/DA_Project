...
\vspace{0.5em} \noindent\textbf{Bilanciamento del Dataset e Analisi delle Dinamiche Latenti}}
...
\vspace{0.5em} \noindent\textbf{Clustering (Unsupervised):} 

L’analisi esplorativa non supervisionata ha previsto l’uso combinato di \texttt{PCA} e \texttt{KMeans}, al fine di ridurre la dimensionalità e identificare gruppi omogenei di paesi:
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{Kmeans(OE).png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{Proof_of_Concepts(IT).png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{RMSE_bootstrap.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{F1_bootstrap.png}
